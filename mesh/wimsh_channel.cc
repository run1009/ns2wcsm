...
//! jpyu
//this class is for tcl create new object
static class WimshChannel1Class : public TclClass {
public:
  WimshChannel1Class() : TclClass("WimshChannel1") {}
  TclObject* create(int, const char*const*) {
    return (new WimshChannel1);
  }
} class_wimsh_channel1;

WimshChannel1::WimshChannel1() { }
...
//! jpyu
int 
WimshChannel1::command(int argc, const char*const* argv)
{
  if(argc == 3 && strcmp(argv[1],"uid") == 0) {
    uid_ = (int) atoi(argv[2]);
    return TCL_OK;
  } else if(argc == 2 && strcmp(argv[1],"getuid") == 0) {
