...
set opt(c_neighbor)	2
set opt(n)              10       ;# meaningful with: chain, ring, grid,
...
# PHY
#
set opt(channel)        4      ;# number of channels
...
#set opt(trfsrc)	{0 1 2 3}
#set opt(trfdst)	{20 19 18 17}
...
set opt(trfprio-def) { }
#set opt(trftype) {cbr cbr cbr cbr cbr cbr cbr cbr}
#set opt(trfnsrc)  { 1    2    1 } ;# number of sources per flow
set opt(trfnsrc) { }
set opt(trfstart) { }
set opt(trfstop)  { }
